...
<p align="center">
  <img src="https://img.shields.io/badge/Java-21_%7C_GraalVM_Native-ED8B00?style=flat-square&logo=openjdk&logoColor=white" alt="Java 21" />
  <img src="https://img.shields.io/badge/Spring_Boot-3.5.x-6DB33F?style=flat-square&logo=springboot&logoColor=white" alt="Spring Boot" />
  <img src="https://img.shields.io/badge/React-19-61DAFB?style=flat-square&logo=react&logoColor=black" alt="React 19" />
  <img src="https://img.shields.io/badge/Protocol-MCP_(Model_Context)-7A52FF?style=flat-square&logo=anthropic&logoColor=white" alt="MCP" />
  <img src="https://img.shields.io/badge/Edge-Cloudflare_Pages_%26_Workers-F38020?style=flat-square&logo=cloudflare&logoColor=white" alt="Cloudflare" />
  <img src="https://img.shields.io/badge/Location-Memphis,_TN_🛠️-blueviolet?style=flat-square" alt="Memphis TN" />
</p>
...
```mermaid
flowchart TD
    subgraph RadTome_Core ["⚡ RadTome Forge"]
        RT_Phil["Mission: High-Utility, Low-Maintenance Tooling"]
        RT_Codex["Architectural Codex & Engineering Blueprints"]
    end

    subgraph SaaS_Factory ["🏗️ The SaaS Factory"]
        OrgSets["OrgSets.com (Multi-Tenant SaaS)"]
        GraalVM["Spring Boot 3.5 + GraalVM Native (40MB RAM, 15ms start)"]
        Ledger["Stripe Connect Automated Split Ledgers"]
        OrgSets --> GraalVM
        OrgSets --> Ledger
    end

    subgraph Agentic_AI ["🤖 AI & Protocols"]
        MCP["MCP Codex (mcp-codex.com)"]
        JSONRPC["Model Context Protocol (JSON-RPC 2.0)"]
        QuickSnipe["QuickSnipe (Chrome MV3 Extension)"]
        MultiLLM["Multi-LLM Fallback (Gemini / GPT-4o / Groq)"]
        MCP --> JSONRPC
        QuickSnipe --> MultiLLM
    end

    subgraph Client_DevTools ["⚡ Local-First & Edge"]
        PP["PrettyPrint (prettyprint.radtome.com)"]
        ZeroTel["Zero Telemetry Client AST Parser"]
        CF["Cloudflare Pages & Edge Workers"]
        PP --> ZeroTel
        RadTome_Core --> CF
    end

    RadTome_Core --> SaaS_Factory
    RadTome_Core --> Agentic_AI
    RadTome_Core --> Client_DevTools
```
